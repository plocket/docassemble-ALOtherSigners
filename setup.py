...
setup(name='docassemble.ALOtherSigners',
      ...
      install_requires=[],
      zip_safe=False,
      package_data=find_package_data(where='docassemble/ALOtherSigners/', package='docassemble.ALOtherSigners'),
     )
